...
int main(int argc, char **argv)
{
    ...
    app.setStyleSheet(
        ...
        "QSlider[isVisuallyDisabled=true]::handle:horizontal, QScrollBar, "
        "QSlider[isVisuallyDisabled=false]::add-page:horizontal, QScrollBar::handle:disabled { "
        "background: #550080; }"
        ...
        "color: #550080; }"
        "QSlider[isVisuallyDisabled=false]::sub-page:horizontal, QScrollBar::handle { background: "
        "#a0f; }"
        ...
        "QSlider::groove:horizontal, QMenu::separator { background: #a0f; height: 1; }"
        ...
        "QScrollBar:handle:vertical { min-height: 32; }"
